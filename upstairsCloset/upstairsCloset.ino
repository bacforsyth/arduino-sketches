...
// tempNode V4
// Simple Temperature Node, using two DS18B20
...
#define SET_NODE   		3  		// wireless node ID 
...
#define BATT_SENSE_PORT 4		// sense battery voltage on this port
...
DeviceAddress sensor1 = {0x28, 0xB9, 0xAA, 0x96, 0x5, 0x0, 0x0, 0xDC};
DeviceAddress sensor2 = {0x28, 0x9F, 0xAE, 0x95, 0x5, 0x0, 0x0, 0x4F};
...
static int readTemp(DeviceAddress addr) {
    ...
    return sensors.getTempC(addr)*10;
}
...
static void doMeasure() {
  ...
  payload.sensor1 = readTemp(sensor1);
  payload.sensor2 = readTemp(sensor2);
